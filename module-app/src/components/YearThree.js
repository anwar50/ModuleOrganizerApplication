...
class YearThree extends React.Component{
    constructor(props)
    {
        super(props);
        this.state = {
    ...
    componentDidMount = () => {
        axios.get('http://localhost:8080/api/thirdyears').then((res) => {
        ...
        <Layout>
            <Content style={{padding: "0 50px"}}>
                <Breadcrumb style={{margin: "16px", textAlign: "center"}}>
                    <Breadcrumb.Item style={{borderBottomColor: "red", color:"red", size:"30px"}}>Year 3</Breadcrumb.Item>
                </Breadcrumb>
